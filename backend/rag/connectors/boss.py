...
# 12 fiches P0 : doctrine sécurité sociale — sujet paie principalement
P0_FICHES: list[tuple[str, str, list[str]]] = [
    ("assiette-cotisations",
     "accueil/regles-generales-cotisations/principes-generaux-soumission-cotisations.html",
     ["paie"]),
    ("avantages-en-nature",
     "accueil/regles-generales-cotisations/avantages-en-nature.html",
     ["paie"]),
    ("frais-professionnels",
     "accueil/regles-generales-cotisations/frais-professionnels.html",
     ["paie"]),
    ("indemnites-rupture",
     "accueil/regles-generales-cotisations/indemnites-de-rupture.html",
     ["paie"]),
    ("csg-crds",
     "accueil/regles-generales-cotisations/csg-crds.html",
     ["paie"]),
    ("mns-mesures-jeunes",
     "accueil/exonerations-allegements/contrats-favorisant-emploi.html",
     ["paie"]),
    ("allegements-generaux",
     "accueil/exonerations-allegements/allegement-general.html",
     ["paie"]),
    ("taux-reduit-allocations",
     "accueil/exonerations-allegements/baisse-taux-cotisations-allocations-familiales.html",
     ["paie"]),
    ("taux-reduit-maladie",
     "accueil/exonerations-allegements/baisse-taux-cotisations-maladie.html",
     ["paie"]),
    ("exo-aide-domicile",
     "accueil/exonerations-allegements/services-aide-personne.html",
     ["paie"]),
    ("exo-heures-sup",
     "accueil/exonerations-allegements/heures-supplementaires.html",
     ["paie"]),
    ("epargne-salariale",
     "accueil/protection-sociale-complementaire/epargne-salariale.html",
     ["paie"]),
]
