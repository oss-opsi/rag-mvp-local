  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="flex h-full w-full flex-col items-center">
        ...
        <div
          className={cn(
            "flex h-16 w-full items-center justify-center border-b",
            RAIL_SEPARATOR.replace("bg-", "border-"),
          )}
        >
          <Link
            href="/chat"
            ...
            className="rounded-xl outline-none ring-offset-[hsl(255_35%_26%)] transition-transform hover:scale-105 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
          >
            <BrandMark size={36} />
          </Link>
        </div>
